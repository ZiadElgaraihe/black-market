    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text(
            '''
      تطبيق " بكام في السوق السوداء " والقائمين عليه وشركة Flux Tech مالكة التطبيق لا يقومون بالتجارة في العملة ولا يشجعون عليها... بل بالعكس تماما نشجع على الالتزام بالسوق الرسمي للعملات حفاظا علي أموالكم\n
